(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0745/6093/0094/t/1/assets/appstle-subscription.js?v=1681043084");
      ...
      RS.Config = {
        ...
        "shop": "cliffrose-doula.myshopify.com",
